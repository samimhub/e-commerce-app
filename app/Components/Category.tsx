        ...
        <div className="mt-6 flex flex-col  md:flex-row items-center gap-4">
            ...
            <div className="md:w-1/2">
                <div className="grid grid-cols-2 gap-4">
                    <Link href="/"><img src="fashion.jpg" alt="fashion" className="hover:scale-105 transition-all duration-200"/></Link>
                    <Link href="/"><img src="fashion.jpeg" alt="fashion"className="hover:scale-105 transition-all duration-200"/></Link>
                </div>
