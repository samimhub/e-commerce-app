...
const Slide: React.FC<propsType> = ({ img, title, mainTitle, discount }) => {
  ...
  return (
    <div className="outline-none border-none relative " style={{textShadow :"0 0 5px white"}}>
      ...
      <Image className='w-[100%] px-1.5 lg:h-[410px] lg:max-w-screen-xl rounded-2xl object-cover lg:mx-auto '
        src={img} alt='banner' width={2000} height={1000} />
    </div>
  )
}
